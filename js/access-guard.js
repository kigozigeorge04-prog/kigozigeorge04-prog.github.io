...
// Expose the values explicitly for protected pages that have their own
// authentication bootstrap. Top-level `const` bindings are not properties of
// `window`, so pages must not rely on them being available as globals.
